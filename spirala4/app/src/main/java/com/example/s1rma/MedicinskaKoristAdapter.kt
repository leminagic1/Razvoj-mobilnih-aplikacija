...
class MedicinskaKoristAdapter(
    context: Context,
    private val items: List<MedicinskaKorist>
) : ArrayAdapter<MedicinskaKorist>(context, 0, items) {

    private val selectedItems = mutableSetOf<MedicinskaKorist>()
    ...
    fun getSelectedItems(): Set<MedicinskaKorist> {
